...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if(idade == 0 || idade < 0) throw new IllegalArgumentException("Verificar argumentos");
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            if(pontos == 0 || pontos < 0) throw new IllegalArgumentException("Verificar argumentos");
            this.pontos = pontos;
            return this;
        }
        ...
        public Motorista build() {
            if(nome.isEmpty() || habilitacao.isEmpty()) throw new NullPointerException("Verificar informações");
